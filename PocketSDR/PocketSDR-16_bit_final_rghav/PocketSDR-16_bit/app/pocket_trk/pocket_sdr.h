...
#define STATE_LOCK 3		  // channel state lock
	...
	typedef struct
	{								// SDR receiver navigation data type
	...
	typedef struct
	{							 // SDR receiver channel thread type
	...
	{							 // receiver channel type
		...
		struct sdr_rcv_tag *rcv; // pointer to receiver

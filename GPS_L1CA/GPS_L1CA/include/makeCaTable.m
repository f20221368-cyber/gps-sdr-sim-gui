...
% millisecond).
% (ts * (1:samplesPerCode)) / tc: Divides these time points by the code period (tc). 
% This effectively normalizes the time points with respect to the code period, scaling them to
% be in terms of the code period.

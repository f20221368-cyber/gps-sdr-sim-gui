...
settings.fileName           = "../../gps-sdr-sim/gpssim.bin";
% settings.fileName           = 'C:\Users\Arya\Downloads\bt_driver\capture_17_04_24_1.dat';
...
settings.resamplingThreshold    = 0e6;            % [Hz]
...
settings.dllNoiseBandwidth       = 1.5; %(default value in gnss sdr is 2)  %[Hz]
settings.dllCorrelatorSpacing    = 0.5;     %[chips]

% Carrier tracking loop parameters
settings.pllDampingRatio         = 0.7;
settings.pllNoiseBandwidth       = 20;      %[Hz]  %(default value in gnss sdr is 20)
